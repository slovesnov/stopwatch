...
class DigitalFont {
	...
	void init(double sizex, double sizey, double _thicknessx, double _thicknessy,
			double _symbolMargin, double _angleMargin) {
	...
	PDD getSize() const {
		return std::make_pair(width - 2 * thicknessx, (height - 3 * thicknessy) / 2);
	}
